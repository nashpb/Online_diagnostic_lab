        ...
        <form class="form-horizontal" method="post">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="text" id="inputEmail" name="service" value="<?php echo $service_row['service_offer']; ?>" required/>
                </div>
            </div>
            <div class="control-group">
...
if (isset($_POST['edit'])) {
    ...
    mysqli_query($con,"update service set service_offer='$service', price='$price' where user_id='$user_id'");
    ?>
    <script>
