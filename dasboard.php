		...
		<div class="row">
			...
			<div class="span6">
				...
				if (isset($_POST['sub'])) {
					...
					$query = mysqli_query($con, "select * from schedule where date = '$date' and member_id = '$session_id' ") or die(mysql_error());
					...
					if ($count > 0) { ?>
						...
						?>
						<div class="question">
							<div class="alert alert-success">Your the number <strong>
									<?php echo $equal; ?>
								</strong> client in this date <strong>
									<?php echo $date; ?>
								</strong></div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select name="service" required>
								<option></option>
								<?php $query = mysqli_query($con, "select * from service") or die(mysql_error());
			...
			<div class="span3">
				...
				<table class="table  table-bordered">
					...
					<tbody>
						...
						<?php $user_query = mysqli_query($con, "select * from service") or die(mysql_error());
